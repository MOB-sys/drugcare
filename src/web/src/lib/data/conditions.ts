...
export const CONDITIONS: ConditionItem[] = [
  ...
  { keyword: "임부", label: "임산부", description: "임신 중인 여성에 대한 주의사항" },
  ...
  { keyword: "전립선비대", label: "전립선비대증", description: "배뇨 장애를 동반하는 전립선 비대" },
  { keyword: "갑상선", label: "갑상선 질환", description: "갑상선기능항진/저하증" },
  { keyword: "알레르기", label: "알레르기", description: "약물 과민반응, 아나필락시스 등" },
  { keyword: "뇌전증", label: "뇌전증(간질)", description: "반복적 발작을 동반하는 신경 질환" },
  { keyword: "우울증", label: "우울증", description: "기분장애, 항우울제 관련 주의사항" },
  { keyword: "혈액응고", label: "혈액응고장애", description: "출혈 경향, 항응고제 복용 관련" },
