...
export function SmartAppBanner() {
  ...
  return (
    <div className="bg-teal-600 text-white px-4 py-3 flex items-center gap-3" data-testid="smart-app-banner">
      ...
      <a
        ...
        className="shrink-0 px-3 py-1.5 rounded-md bg-white text-teal-700 text-sm font-medium hover:bg-teal-50 transition-colors"
      >
        앱 설치
      </a>
      <button
        onClick={handleDismiss}
        className="shrink-0 p-1 text-teal-200 hover:text-white transition-colors"
        aria-label="배너 닫기"
      >
