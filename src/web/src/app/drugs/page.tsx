              ...
              {CHOSUNG.map((key) => {
                ...
                return hasItems ? (
                  ...
                  >
                    ...
                    <span className="text-[11px] sm:text-xs text-gray-500 dark:text-gray-400 mt-0.5 sm:mt-1">{count.toLocaleString()}</span>
                  </Link>
                ) : (
                  <div
                    key={key}
                  ...
                  >
                    ...
                    <span className="text-[11px] sm:text-xs text-gray-300 dark:text-gray-600 mt-0.5 sm:mt-1">0</span>
                  </div>
                );
              })}
            </div>
