        ...
        <div className="max-w-3xl mx-auto px-4">
          <div className="grid grid-cols-2 sm:grid-cols-4 gap-2 sm:gap-6">
            ...
            <div className="flex flex-col items-center text-center p-4">
              ...
              <p className="text-lg sm:text-xl font-bold text-[var(--color-text)]">366,629<span className="text-sm font-medium">건</span></p>
        ...
        <div className="max-w-3xl mx-auto px-4">
          ...
          <div className="grid gap-3 sm:gap-6 grid-cols-2 sm:grid-cols-3">
            <Link href="/check" className="group block bg-white dark:bg-gray-800 rounded-xl border border-gray-200 dark:border-gray-700 p-4 sm:p-6 shadow-sm hover:shadow-md hover:border-[var(--color-primary-100)] transition-all">
              <div className="w-10 h-10 rounded-lg bg-blue-50 dark:bg-blue-900/30 flex items-center justify-center mb-2 sm:mb-3 group-hover:bg-blue-100 dark:group-hover:bg-blue-900/50 transition-colors">
            ...
            <Link href="/drugs" className="group block bg-white dark:bg-gray-800 rounded-xl border border-gray-200 dark:border-gray-700 p-4 sm:p-6 shadow-sm hover:shadow-md hover:border-[var(--color-primary-100)] transition-all">
              <div className="w-10 h-10 rounded-lg bg-rose-50 dark:bg-rose-900/30 flex items-center justify-center mb-2 sm:mb-3 group-hover:bg-rose-100 dark:group-hover:bg-rose-900/50 transition-colors">
            ...
            <Link href="/supplements" className="group block bg-white dark:bg-gray-800 rounded-xl border border-gray-200 dark:border-gray-700 p-4 sm:p-6 shadow-sm hover:shadow-md hover:border-[var(--color-primary-100)] transition-all">
              <div className="w-10 h-10 rounded-lg bg-green-50 dark:bg-green-900/30 flex items-center justify-center mb-2 sm:mb-3 group-hover:bg-green-100 dark:group-hover:bg-green-900/50 transition-colors">
            ...
            <Link href="/foods" className="group block bg-white dark:bg-gray-800 rounded-xl border border-gray-200 dark:border-gray-700 p-4 sm:p-6 shadow-sm hover:shadow-md hover:border-[var(--color-primary-100)] transition-all">
              <div className="w-10 h-10 rounded-lg bg-orange-50 dark:bg-orange-900/30 flex items-center justify-center mb-2 sm:mb-3 group-hover:bg-orange-100 dark:group-hover:bg-orange-900/50 transition-colors">
            ...
            <Link href="/herbal-medicines" className="group block bg-white dark:bg-gray-800 rounded-xl border border-gray-200 dark:border-gray-700 p-4 sm:p-6 shadow-sm hover:shadow-md hover:border-[var(--color-primary-100)] transition-all">
              <div className="w-10 h-10 rounded-lg bg-emerald-50 dark:bg-emerald-900/30 flex items-center justify-center mb-2 sm:mb-3 group-hover:bg-emerald-100 dark:group-hover:bg-emerald-900/50 transition-colors">
            ...
            <Link href="/tips" className="group block bg-white dark:bg-gray-800 rounded-xl border border-gray-200 dark:border-gray-700 p-4 sm:p-6 shadow-sm hover:shadow-md hover:border-[var(--color-primary-100)] transition-all">
              <div className="w-10 h-10 rounded-lg bg-teal-50 dark:bg-teal-900/30 flex items-center justify-center mb-2 sm:mb-3 group-hover:bg-teal-100 dark:group-hover:bg-teal-900/50 transition-colors">
            ...
            <Link href="/cabinet" className="group block bg-white dark:bg-gray-800 rounded-xl border border-gray-200 dark:border-gray-700 p-4 sm:p-6 shadow-sm hover:shadow-md hover:border-[var(--color-primary-100)] transition-all">
              <div className="w-10 h-10 rounded-lg bg-amber-50 dark:bg-amber-900/30 flex items-center justify-center mb-2 sm:mb-3 group-hover:bg-amber-100 dark:group-hover:bg-amber-900/50 transition-colors">
        ...
        <div className="max-w-3xl mx-auto px-4">
          ...
          <div className="grid gap-3 sm:gap-4 grid-cols-2 sm:grid-cols-3">
            <Link href="/symptoms" className="group block bg-white dark:bg-gray-800 rounded-xl border border-gray-200 dark:border-gray-700 p-3 sm:p-5 shadow-sm hover:shadow-md hover:border-[var(--color-primary-100)] transition-all">
              <div className="w-9 h-9 rounded-lg bg-purple-50 dark:bg-purple-900/30 flex items-center justify-center mb-2 group-hover:bg-purple-100 dark:group-hover:bg-purple-900/50 transition-colors">
            ...
            <Link href="/drugs/side-effects" className="group block bg-white dark:bg-gray-800 rounded-xl border border-gray-200 dark:border-gray-700 p-3 sm:p-5 shadow-sm hover:shadow-md hover:border-[var(--color-primary-100)] transition-all">
              <div className="w-9 h-9 rounded-lg bg-red-50 dark:bg-red-900/30 flex items-center justify-center mb-2 group-hover:bg-red-100 dark:group-hover:bg-red-900/50 transition-colors">
            ...
            <Link href="/drugs/identify" className="group block bg-white dark:bg-gray-800 rounded-xl border border-gray-200 dark:border-gray-700 p-3 sm:p-5 shadow-sm hover:shadow-md hover:border-[var(--color-primary-100)] transition-all">
              <div className="w-9 h-9 rounded-lg bg-cyan-50 dark:bg-cyan-900/30 flex items-center justify-center mb-2 group-hover:bg-cyan-100 dark:group-hover:bg-cyan-900/50 transition-colors">
            ...
            <Link href="/drugs/conditions" className="group block bg-white dark:bg-gray-800 rounded-xl border border-gray-200 dark:border-gray-700 p-3 sm:p-5 shadow-sm hover:shadow-md hover:border-[var(--color-primary-100)] transition-all">
              <div className="w-9 h-9 rounded-lg bg-orange-50 dark:bg-orange-900/30 flex items-center justify-center mb-2 group-hover:bg-orange-100 dark:group-hover:bg-orange-900/50 transition-colors">
                <svg className="w-5 h-5 text-orange-600" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            <Link href="/news" className="group block bg-white dark:bg-gray-800 rounded-xl border border-gray-200 dark:border-gray-700 p-3 sm:p-5 shadow-sm hover:shadow-md hover:border-[var(--color-primary-100)] transition-all">
              <div className="w-9 h-9 rounded-lg bg-indigo-50 dark:bg-indigo-900/30 flex items-center justify-center mb-2 group-hover:bg-indigo-100 dark:group-hover:bg-indigo-900/50 transition-colors">
