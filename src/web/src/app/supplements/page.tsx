    ...
    <>
      ...
      <section className="max-w-3xl mx-auto px-4 py-6">
        ...
        <div className="space-y-6">
          {/* 한글 초성 */}
          <div>
            <h2 className="text-sm font-semibold text-gray-500 dark:text-gray-400 mb-3">한글 (가나다)</h2>
              ...
              {CHOSUNG.map((key) => {
                ...
                return hasItems ? (
                  ...
                  >
                    ...
                    <span className="text-[10px] sm:text-xs text-gray-500 dark:text-gray-400 mt-0.5 sm:mt-1">{count.toLocaleString()}</span>
                  </Link>
                ) : (
                  <div
                    key={key}
                    className="flex flex-col items-center justify-center rounded-xl p-2 sm:p-3 bg-gray-50 dark:bg-gray-800 border border-gray-100 dark:border-gray-700"
                  >
                    <span className="text-base sm:text-lg font-bold text-gray-300 dark:text-gray-600">{key}</span>
                    <span className="text-[10px] sm:text-xs text-gray-300 dark:text-gray-600 mt-0.5 sm:mt-1">0</span>
                  </div>
                );
              })}
            </div>
          ...
          {/* 알파벳 */}
          <div>
            <h2 className="text-sm font-semibold text-gray-500 dark:text-gray-400 mb-3">알파벳 (A-Z)</h2>
